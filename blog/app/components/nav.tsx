...
export function Navbar() {
  return (
    <header className="sticky top-0 z-40 mb-16  backdrop">
      <nav className="flex items-right justify-between md:px-10 py-5 font-mono text-xs tracking-[0.25em] uppercase">
        <Link href="/" className="text-foreground font-bold shrink-0">
          dev.exe
        </Link>
        <div className="hidden md:flex items-right gap-4">
